...
elif args.model_name == 'RGCN_s':
    model, data = RGCN_s().to(device), data.to(device)
...
print("Model name: " + args.model_name + " Dataset: " + args.dataset)